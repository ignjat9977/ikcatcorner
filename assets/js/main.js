...
function printDataFromCart(products){
    ...
    <table class="table table-active">
        <thead>
            <tr>
                <th class="ik-mobile">SL No.</th>
                <th>Product</th>
                <th class="ik-mobile">Name</th>
                <th>Price</th>
                <th>Quantity</th>
                <th class="ik-mobile">Sum</th>
        ...
        function generateTr(p) {
            ...
            <td class="invert ik-mobile">${p.id}</td>
            <td class="invert-image">
                <a href="shop.html">
                    <img src="assets/img/${p.img.src}" style='height:100px' alt="${p.img.alt}" class="img-fluid" />
                </a>
            </td>
            <td class="invert ik-mobile">${p.name}</td>
            <td class="invert">$${p.price.noDis}</td>
            <td class="invert">${p.qty}</td>
            <td class="invert ik-mobile">$${p.price.noDis * p.qty}</td>
            <td class="invert">
                <div class="rem">
                    <div class=""><button class="btn btn-danger" id="ik-remove" onclick='removeFromCart(${p.id})'><i class="bi bi-x-circle-fill"></i></button> </div>
                </div>
            </td>
        </tr>`
        }
